...
public class MainApp extends Application {
    ...
    public static void showLogin() throws Exception {
      ...
      //FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("/org/novalearn/views/quiz_app.fxml"));
        FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("/org/novalearn/quizzes-views/quizzes.fxml"));
